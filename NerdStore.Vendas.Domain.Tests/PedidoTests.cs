...
public class PedidoTests
{
    ...
    public void AdicionarItemPedido_PedidoVazio_NovoPedido_DeveAtualizarValor()
    {
        //Arrange
        var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        var pedidoItem = new PedidoItem(Guid.NewGuid(), "ProdutoTeste", 2, 100);
    ...
    public void AdicionarItemPedido_ItemExistente_DeveIncrementarUnidadesSomarValores()
    {
        ...
        var pedidoItem = new PedidoItem(produtoId, "ProdutoTeste", 2, 100);
        pedido.AdicionarItem(pedidoItem);
    ...
    public void AdicionarItemPedido_UnidadesItemAcimaDoPermitido_DeveRetornarException()
    {
        ...
        var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        var produtoId = Guid.NewGuid();
        var pedidoItem = new PedidoItem(produtoId, "ProdutoTeste", 16, 100);
    ...
    public void AdicionarItemPedido_UnidadesItemAbaixoDoPermitido_DeveRetornarException()
    {
        ...
        var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        var produtoId = Guid.NewGuid();
        var pedidoItem = new PedidoItem(produtoId, "ProdutoTeste", 0, 100);
    ...
    public void AdicionarItemPedido_ItemExistenteSomaUnidadesAcimaDoPermitido_DeveRetornarException()
    {
        ...
        var pedidoItem2 = new PedidoItem(produtoId, "Produto Teste", 15, 100);
        pedido.AdicionarItem(pedidoItem);
    ...
    [Fact(DisplayName = "AtualizarItemPedido_ItemValido_DeveAtualizarQuantidade")]
    [Trait("Categoria", "Vendas-Pedido")]
    public void AtualizarItemPedido_ItemValido_DeveAtualizarQuantidade()
    {
        ...
        var pedidoItem = new PedidoItem(produtoId, "ProdutoTeste", 2, 100);
        pedido.AdicionarItem(pedidoItem);
        var pedidoItemAtualizado = new PedidoItem(produtoId, "ProdutoTeste", 5, 100);
    ...
    public void AtualizarItemPedido_PedidoComProdutosDiferentes_DeveAtualizarValorTotal()
    {
        ...
        var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        var produtoId = Guid.NewGuid();
        var pedidoItemExistente1 = new PedidoItem(Guid.NewGuid(), "ProdutoXpto", 2, 100);
        var pedidoItemExistente2 = new PedidoItem(produtoId, "ProdutoTeste", 3, 15);
    ...
    [Trait("Categoria", "Vendas-Pedido")]
    public void AtualizarItemPedido_ItensUnidadeAcimaDoPermitido_DeveRetornarExcpetion()
    {
        //Arrange
        var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        var produtoId = Guid.NewGuid();

        var pedidoItemExistente1 = new PedidoItem(produtoId, "ProdutoTeste", 3, 15);

        pedido.AdicionarItem(pedidoItemExistente1);

        var pedidoItemAtualizado = new PedidoItem(produtoId, "ProdutoTeste", 16, 15);

        // Act & Assert
        Assert.Throws<DomainException>(() => pedido.AtualizarItem(pedidoItemAtualizado));
    }

    [Fact(DisplayName = "Remover Pedido Item Inexistente")]
    [Trait("Categoria", "Vendas-Pedido")]
    public void RemoverItemPedido_ItemNaoExistenteNaLista_DeveRetornarExcpetion()
    {
        //Arrange
        var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
